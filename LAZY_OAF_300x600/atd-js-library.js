...
var adTech = (function () {
	...
	_this.init = function () {
		...
		_this.fitText = function (textElement, method, lines = 1) {
			if (method === 'fit') {
	...
	_this.exits = function (e) {
		if (e.target.dataset.utm === 'true') {
			Enabler.exitOverride(e.currentTarget.dataset.reporting, _this.addSuff(_this.getUtmParams(e.currentTarget.dataset.exit, snippet.SF)));
		} else {
			Enabler.exitOverride(e.currentTarget.dataset.reporting, _this.addSuff(e.currentTarget.dataset.exit));
		}
	};
